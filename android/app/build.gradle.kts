...
// This file is git-ignored and provided by CI (or locally) — when absent,
// release builds fall back to debug signing so `flutter run --release` works.
...
android {
    namespace = "com.mass.merchant_app"
    ...
    defaultConfig {
        ...
        applicationId = "com.mass.merchant_app"
    ...
    buildTypes {
        ...
        release {
            ...
            // local `flutter run --release` still works without secrets.
